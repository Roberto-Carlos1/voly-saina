...
INSERT INTO machine(nom, type_machine, description, prix_jour, id_etat_machine, localisation, disponible) VALUES
('Tracteur standard', 'tracteur', 'Préparation des sols et travaux lourds', 150000, 1, 'Zone pilote', TRUE),
('Motoculteur 18CV', 'motoculteur', 'Préparation des petites et moyennes surfaces', 80000, 1, 'Zone pilote', TRUE),
('Pulvérisateur agricole', 'pulverisateur', 'Traitement des cultures', 30000, 1, 'Zone pilote', TRUE),
('Remorque agricole', 'remorque', 'Transport des récoltes et intrants', 50000, 1, 'Zone pilote', TRUE);
