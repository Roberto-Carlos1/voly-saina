...
INSERT INTO machine(nom, id_type_machine, description, prix_jour, id_etat_machine, localisation, disponible) VALUES
('Tracteur standard', 1, 'Préparation des sols et travaux lourds', 150000, 1, 'Zone pilote', TRUE),
('Motoculteur 18CV', 2, 'Préparation des petites et moyennes surfaces', 80000, 1, 'Zone pilote', TRUE),
('Pulvérisateur agricole', 3, 'Traitement des cultures', 30000, 1, 'Zone pilote', TRUE),
('Remorque agricole', 4, 'Transport des récoltes et intrants', 50000, 1, 'Zone pilote', TRUE);
